...
define("PASSWORD", "");
define("DATABASENAME", "project_4_db");
        ...
        <div class="col-sm-4 col-md-3 " id="Scard">
            <form method="post" action="index.php?content=productenpage&action=add&id=<?php echo $product['id'];?>">
                <div class="products" id="test">
                    <img src="<?php echo $product['image'];?>" class="img-responsive" id="image">
    ...
    <tr>
        <td colspan="5">
            ...
            ?>
                ...
                <a href="https://newint.org/features/1989/08/05/ten" class="btn btn-danger btn-lg active" role="button" aria-pressed="true">Checkout</a>
            <?php endif; endif; ?>
        </td>
    </tr>
    <?php 
