...
$id = mysqli_insert_id($conn);
        ...
        if ($result){
            ...
            <body>
                ...
                <p>U heeft zich zojuist geregistreerd op de site www.WijKopenFruit.nl</p>
                <p>Om te klikken op de onderstaande link kunt u het acrivatieproces voltooien.</P>
                <p>Klik op deze link <a href="http://www.wijkopenfruit.nl/index.php?content=activate&id=' .$id. '&pwh=' .$password_hash. '">hier</a> om je te regristreren</P>
                <p>Bedankt voor het registreren</p>
                <p>Met vriendelijke groet,</p>
                <p>M. Breunesse</p>
                <p>CEO WijKopenFruit.nl</p>
            </body>
            </html>';
        
            $headers = "MIME-Version: 1.0\r\n";
            $headers .= "Content-type: text/html; charset-UTF-8\r\n";
            $headers .= "From: admin@SappigFruit.org\r\n";
